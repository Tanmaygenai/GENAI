...
public class Error {
    ...
    public Error withTypeCd(String typeCd) {
        this.typeCd = typeCd;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.typeCd == rhs.typeCd)||((this.typeCd!= null)&&this.typeCd.equals(rhs.typeCd))));
    }
