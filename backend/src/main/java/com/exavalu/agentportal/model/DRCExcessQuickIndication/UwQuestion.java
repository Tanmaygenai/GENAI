...
public class UwQuestion {
    ...
    public UwQuestion withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UwQuestion withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public UwQuestion withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(UwQuestion.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UwQuestion) == false) {
            return false;
        }
        UwQuestion rhs = ((UwQuestion) other);
