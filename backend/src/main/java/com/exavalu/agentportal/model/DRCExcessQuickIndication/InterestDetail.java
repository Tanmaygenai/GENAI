...
public class InterestDetail {
    ...
    public InterestDetail withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public InterestDetail withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public InterestDetail withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(InterestDetail.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InterestDetail) == false) {
            return false;
        }
        InterestDetail rhs = ((InterestDetail) other);
