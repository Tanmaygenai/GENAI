...
public class Deductible__1 {
    ...
    public Deductible__1 withDeductibleCd(String deductibleCd) {
        this.deductibleCd = deductibleCd;
        return this;
    }
    ...
    public Deductible__1 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public Deductible__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Deductible__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Deductible__1) == false) {
            return false;
        }
        Deductible__1 rhs = ((Deductible__1) other);
