...
const EligibilityCheck = () => {
  ...
  var stateData = dropdownVal.map((value, ind) => {
    return value.State!== "" ? (
  ...
  //drop_data.State.map((value, ind) => (value.value))
  ...
  return (
    ...
    <Layout TabName='Eligibility Check' BreadCrum={['My Dashboard', 'Eligibility Check']}>
        ...
        <div class="commonform_box">
          <div class="inf">
            <form class="allForm">
              ...
              <div></div>
              {state !== "" && disable == true ? <p><strong>Eligible Products:</strong><br />XYZ Insurance company is not licensed to provide insurance in the state of {state}</p> : ''}
                      ...
                      <div>
                        ...
                        <p>
                          <>
                            ...
                            {/* {
                                enableProducts[0] === "Yes" && tpciStates.includes(state) && classCodeLevel.Pkg === true && classCodeProduct.CPP === true ?
                                  <Link to={{ pathname: "/tpci", state: {locationState:locationState, state: state, classGroup: classGroup, classCodes: classCodes, product: "Pkg" } }}>
                                    <span className='text-success'>&#10004;</span>
                                    &ensp; Package Submission <br />
                                  </Link>
                                  : <><span className='text-danger'>&#10006;</span>&ensp; Package Submission<br /></>
                            } */}
                          </>
                        </p>
                      </div>
