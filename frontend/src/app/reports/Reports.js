...
const Reports = () => {
    ...
    return (
        <Layout TabName='Reports' BreadCrum={['My Dashboard', 'Reports']}>
            <div className="coverContainer">
                <div class="commonform_box">
                    <div class="inf">
                        <ul>
                            <li><Link to={{ pathname: '/quickIndicationReport' }}><u>Quick Indication/Submission Report</u></Link></li>
                            <li><Link to={{ pathname: '/quoteSubmissionPremiumReport' }}><u>Quote Submission Premium Report</u></Link></li>
                            <li><Link to={{ pathname: '/lossReport' }}><u>Loss Notice Report</u></Link></li>
                            {
                                sessionStorage.getItem("roleType")==="admin"?
                                <li><Link to={{ pathname: '/loginReport' }}><u>Login Report</u></Link></li>
                                :
                                ''
                            }
                        </ul>
