...
import QuoteSubmissionPremiumDetails from "./QuoteSubmissionPremiumReportDetails";
import API_Headers from '../../API_Headers';
import Papa from 'papaparse';
import dropdown_val from '../../dummydata/lossNotice.csv';

const QuoteSubmissionPremiumReport = () => {
...
const onSubmit = async (data) => {
  ...
  return (
    <Layout TabName='Quote Submission Premium Report' BreadCrum={['My Dashboard', 'Quote Submission Premium Report']}>
          ...
          <div class="inf">
            <form class="allForm" onSubmit={handleSubmit(onSubmit)}>
              <div className="grid2">
                <div>
                  <DateInput
                    fieldName="ReportStartDate" label='Start Date' register={register} errors={errors}
                ...
                <div>
                  <DateInput
                    fieldName="ReportEndDate" label='End Date' register={register} errors={errors}
        ...
        <div>
          {
            (isLoaded === false) ? <div class="coverContainer"> </div> :
              <QuoteSubmissionPremiumDetails startDate={startDate} endDate={endDate} productType={productType} />
          }
        </div>
...
export default QuoteSubmissionPremiumReport
