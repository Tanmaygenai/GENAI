...
const AddAutomaticDriverModalData = ({ register, errors, setValue,modalState }) => {
    ...
    return (
        <div class="grid3">
            ...
            <div class="form-element has-value">
                ...
                label="Total Driver Points" defaultValue={modalState.editIndex === null ? "" : modalState.DriverData[modalState.editIndex].TotalDriverPoints} register={register} errors={errors} type='number' min={0} showLabel={true} className="form-field" required={false} lableClass='form-label' activeBold={true} />
            </div>
...
export default AddAutomaticDriverModalData
